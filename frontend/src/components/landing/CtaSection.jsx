    ...
    <section className="px-6 py-28 md:px-16">
      <div className="mx-auto max-w-3xl text-center">
        <h2 className="font-display text-3xl font-bold text-primary md:text-4xl">
          {t('landing.cta.title', 'Stop paying for empty kilometers.')}
        </h2>
        <p className="mx-auto mt-4 max-w-md text-[#5B7A70]">
          {t('landing.cta.subtitle', 'Join as a shipper, driver, or buyer — the network works better the moment you’re on it.')}
        </p>
